...
0.5 Lucky Semiosis, - 13 janvier 2012 
=========================================================
- Ajout des mots français
- remplacement des splits par des explode
- remplacement des retour string en retour array
- suppresion de la méthide explode
...
class autokeyword {
	...
	function parse_words()
	{
		...
		/*TODO : 
		 * utiliser les dictionnaires du générateur pour les mots usuels et les conjugaisons
		 * utiliser la table flux_utitag de la base de données flux pour trouver les tags à extraire : poids = -1
		*/ 
