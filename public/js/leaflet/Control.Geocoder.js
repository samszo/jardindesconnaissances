...
module.exports = {
	"class": L.Control.extend({
		...
		markGeocode: function(result) {
			...
			//ajout samszo pour récupérer le résultat
			L.DomEvent.addListener(this._geocodeMarker, 'popupopen', function(e) {
				L.DomEvent.preventDefault(e);
				if(setCartoInfo){
				    //on ne conserve que les propriétés pour éviter des conflits
					setCartoInfo(result.properties);
				}
			}, this);					
