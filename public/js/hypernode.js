class hypernode {
    //merci beaucoup à http://bl.ocks.org/rkirsling/5001347
    /*utilise :
    ...
    */
    ...
    constructor(params) {
        ...
        var svg, container, nodes, margin, colors, links, force, drag, dragLine, path, circle
        , selectedNode, selectedLink, mousedownLink, mousedownNode, mouseupNode, lastNodeId
        , colorLigne = 'white';
        ...
        this.init = function () {
            ...
            colors = d3.scaleSequential().domain([0, nodes.length]).interpolator(d3.interpolateSinebow);

            // init D3 force layout
            //pas de force mais placement explicite
            force = d3.forceSimulation()
                .force('link', d3.forceLink().id((d) => d.id).distance(150))
                .force('charge', d3.forceManyBody().strength(-500))
                .force('x', d3.forceX(me.width / 2))
                .force('y', d3.forceY(me.height / 2))
                .on('tick', tick);
